...
if __name__ == "__main__":
    ...
    # Save final model
    torch.save(spn_model.state_dict(), os.path.join(MODEL_SAVE_PATH, FINAL))

    np.savez(os.path.join(RESULT_PATH, f'{RANDOM_STATE}_spn_training_results.npz'),
